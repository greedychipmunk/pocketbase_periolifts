...
tools: ['bash', 'view', 'create', 'edit', 'report_progress', 'code_review', 'codeql_checker', 'gh-advisory-database', 'github-mcp-server-get_file_contents', 'github-mcp-server-list_issues', 'github-mcp-server-search_code', 'github-mcp-server-search_repositories', 'github-mcp-server-get_commit', 'github-mcp-server-list_commits', 'github-mcp-server-list_branches', 'github-mcp-server-list_pull_requests', 'github-mcp-server-pull_request_read', 'github-mcp-server-issue_read']
---
